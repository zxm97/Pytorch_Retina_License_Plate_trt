...
model_fp32 = load_model(model_fp32, 'weights/ccpd_custom/mobilenet0.25_epoch_24_ccpd_blue+green+yellow+white_20231101.pth', True)
...
torch.onnx.export(model_fp32, input, ONNX_FILE_PATH, input_names=['input'],
                  output_names=['output0', 'output1' 'output2'], export_params=True, opset_version=11,
                  dynamic_axes={
                          'input': {2: 'input_height', 3: 'input_width'},
                          'output0': {1: 'anchors'}, # [1,16800,4]
                          'output1': {1: 'anchors'}, # [1,16800,2]
                          'output2': {1: 'anchors'}, # [1,16800,8]
                  }
