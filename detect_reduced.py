...
import numpy as np
from data import cfg_mnet_reduced, cfg_re50
...
# 23 good
parser.add_argument('-m', '--trained_model', default='weights/mobilenet0.25_epoch_100_ccpd_blue+green+yellow+white_20231108_reduced.pth',
