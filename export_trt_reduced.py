...
tensorrt_engine_path = 'weights/mobilenet0.25_epoch_100_ccpd_blue+green+yellow+white_20231108_reduced' + '_' + precision + '.engine'
...
calib_cache = "./calibration_reduced.cache" # The file path for INT8 calibration cache to use
...
get_engine(ONNX_FILE_PATH, tensorrt_engine_path)
