from models.retina_reduced import Retina
from detect import load_model
from data import cfg_mnet_reduced
import numpy as np
import cv2
import torch
import onnx
...
torch_model_path = 'weights/mobilenet0.25_epoch_100_ccpd_blue+green+yellow+white_20231108_reduced.pth'
ONNX_FILE_PATH = 'weights/mobilenet0.25_epoch_100_ccpd_blue+green+yellow+white_20231108_reduced.onnx'
...
model_fp32 = Retina(cfg_mnet_reduced, phase='export') # phase can be any value except "train"
