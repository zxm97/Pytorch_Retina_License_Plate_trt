...
from prepare_data.text_list_adapter_resize640 import TextListAdapter
...
if __name__ == '__main__':
    write_file(data_set_file_path='E:/plate_recognition/Pytorch_Retina_License_Plate_empty_label/prepare_data/ccpd_dataset/train/')
