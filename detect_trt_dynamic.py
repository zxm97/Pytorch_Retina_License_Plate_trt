...
parser.add_argument('--engine_file_path', default='weights/mobilenet0.25_epoch_24_ccpd_blue+green+yellow+white_20231101_fp16_dynamic.engine', help='trt engine file')
...
parser.add_argument('--input_w', default=720, type=int, help='tensorrt input width') # 720
parser.add_argument('--input_h', default=1160, type=int, help='tensorrt input height') # 1160
...
def main():
    ...
    with load_engine(args.engine_file_path) as engine, engine.create_execution_context() as context:
        #print('context.get_binding_shape(0)', context.get_binding_shape(0)) # (1, 3, -1, -1)
        print('context.get_binding_shape()', context.get_binding_shape(0)) # (1, 3, -1, -1)
        ...
        context.set_binding_shape(0, (1, 3, 1160, 720))
        context.set_binding_shape(1, (1, 34372, 4))
        context.set_binding_shape(2, (1, 34372, 2))
        context.set_binding_shape(3, (1, 34372, 8))
        #
        print('context.get_binding_shape(0)', context.get_binding_shape(0))
        print('context.get_binding_shape(1)', context.get_binding_shape(1))
        ...
        if os.path.isdir(input_path):
            ...
            for image_file in image_files:
                ...
                if args.preprocess_method == 'torch':
                    ...
                    image_raw, image = preprocess(os.path.join(input_path, image_file))
