...
class ImageBatcher:
    ...
    def preprocess_image_efficientdet(self, image_path):
        """
    ...
    def preprocess_image(self, image_path):
        ...
        * EfficientDet: Resizes and pads the image to fit the input size.
        ...
        img = resizeAndPad(img, (input_h, input_w)) # h, w
        # cv2.imshow('rp', img)
        # cv2.waitKey(0)
        ...
        if self.format == "NCHW": # [32, 3, 640, 640]
            image = np.transpose(img, (2, 0, 1))
        return image

    def get_batch_efficientdet(self):
        """
